...
echo "Paper auto-trade is enabled by default; broker submission still requires STOCKML_ALPACA_SUBMIT_ORDERS=true and live trading remains disabled by default."
