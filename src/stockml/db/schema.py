...
position_events = Table(
    ...
    Column("scan_candidate_id", String(200)),
    Column("parent_candidate_id", String(200)),
    Column("event_key", String(200)),
    Column("client_order_id", String(200)),
    Column("broker_order_id", String(200)),
    Column("trade_id", String(200)),
    Column("exit_decision_id", String(200)),
    Column("order_intent", String(200)),
    Column("strategy_mode", String(200)),
    Column("session_mode", String(200)),
    Column("event_session_mode", String(200)),
    Column("planned_execution_session_mode", String(200)),
    Column("actual_submission_session_mode", String(200)),
    Column("candidate_source", String(200)),
    Column("model_version", String(200)),
    Column("lineage_warning", Text),
...
intraday_promotion_log = Table(
    ...
    Column("contributing", ARRAY(Text).with_variant(JSON, "sqlite")),
