...
class CandidateNormalizerBlock(PlaceholderBlock):
    ...
    def normalize_record(self, row: dict[str, Any]) -> Candidate:
        ...
        return Candidate(
            ...
            realtime_price=_float(row, "ai2_realtime_price", "realtime_price", "latest_realtime_price", default=0.0),
            quote_timestamp=_first_text(row, "ai2_quote_timestamp", "quote_timestamp", "realtime_timestamp"),
            quote_age_seconds=_float(row, "ai2_quote_age_seconds", "quote_age_seconds", "realtime_age_seconds", default=0.0),
            sma_20=_float(row, "ai2_sma_20", "sma_20", default=0.0),
            sma_50=_float(row, "ai2_sma_50", "sma_50", default=0.0),
            rsi_14=_float(row, "ai2_rsi_14", "rsi_14", default=0.0),
            atr_14=_float(row, "ai2_atr_14", "atr_14", default=0.0),
            news_count=_int(row, "ai2_news_count", "news_count", default=0),
            sentiment_score=_float(row, "ai2_sentiment_score", "sentiment_score", default=0.0),
            news_attention_score=_float(row, "ai2_news_attention_score", "news_attention_score", default=0.0),
            exchange=_first_text(row, "ai2_exchange", "exchange"),
            currency=_first_text(row, "ai2_currency", "currency"),
            security_type=_first_text(row, "ai2_security_type", "security_type"),
