...
def order_row(row: pd.Series, config: AlpacaConfig) -> dict:
    ...
    return {
        ...
        "ticker_direction_memory_status": row.get("ticker_direction_memory_status", ""),
