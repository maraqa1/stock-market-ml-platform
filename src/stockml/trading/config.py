...
def alpaca_config() -> AlpacaConfig:
    ...
    return AlpacaConfig(
        ...
        max_orders=_int_env("STOCKML_ALPACA_MAX_ORDERS", 20, minimum=1),
        max_notional_per_order=float(os.environ.get("STOCKML_ALPACA_MAX_NOTIONAL_PER_ORDER", "5000")),
        max_total_notional=float(os.environ.get("STOCKML_ALPACA_MAX_TOTAL_NOTIONAL", "50000")),
        ...
        candidate_pool_size=_int_env("STOCKML_CANDIDATE_POOL_SIZE", 200, minimum=1),
